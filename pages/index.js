        ...
        <div className='bg-gray-900 relative'>
          ...
          <div className='message'>
            <div className='pt-32 pb-24'>
              {/* { NOTE: need animation} */}
              <p className='rollText whitespace-nowrap text-8xl font-bold tracking-wider font-sans text-clip bg-clip-text text-transparent bg-gradient-to-r from-cyan-600 to-pink-700 opacity-30' style={{ width: '670px' }}>create wonder</p>
