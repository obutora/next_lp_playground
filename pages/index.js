...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const tl = gsap.timeline({
      repeat: -1, yoyo: false,
      // scrollTrigger: {
      //   trigger: '.movingLight2',
      //   start: 'top center', //object viewport
      //   end: 'top 100px',
      //   markers: true,
      //   scrub: true,
      //   pin: true
    ...
    document.querySelectorAll('.backImage').forEach((image) => {
      gsap.fromTo(image, {
        opacity: 0
      },
        {
    ...
    //product imageのscaleを変化させるアニメーション
    document.querySelectorAll('.product-card, .garally').forEach((image) => {
      gsap.fromTo(image, {
        opacity: 0,
        scale: 1.2,
        duration: 5,
  ...
  return (
    <div>
      ...
      <main className='overflow-auto'>
        ...
        <div className='bg-gray-900 relative -z-10'>
          <div className='message'>
            ...
            <div className='ml-7'>
              ...
              {/* vertical border */}
              <div className='relative h-24 mt-40 lg:h-96'>
                <div className='absolute left-1/2 v-border bg-gradient-to-b from-cyan-300 to-pink-300 text-center mx-auto' style={{ width: '1px', height: '0px', opacity: '0.5' }}></div>
              </div>

              <div className='relative'>
                <div className='backimages'>
                  <img className='backImage absolute top-0 left-0 lg:-top-32  h-28 lg:h-72 opacity-20' src='back1.jpg' />
                  <img className='backImage absolute top-16 right-0 h-28 lg:h-72 opacity-20' src='back3.jpg' />
                  <img className='backImage absolute top-36 right-1/2 lg:right-1/4 w-28 lg:w-72 opacity-20' src='back2.jpg' />
                  <img className='backImage absolute top-1/3 right-0 h-24 lg:h-72 lg:top-auto lg:bottom-20 opacity-20' src='back4.jpg' />
                  <img className='backImage absolute bottom-32 left-8 h-32 lg:h-72 lg:bottom-32 opacity-20' src='back5.jpg' />
                  <img className='backImage absolute bottom-0 left-1/3 w-32 lg:w-72 opacity-20 lg:-bottom-48' src='back6.jpg' />
                </div>
                <div className='brand_text absolute top-1/3'>
                  <p className='text-3xl lg:text-6xl text-gray-200 tracking-widest font-mono'>image branding</p>
                  <span className='block mt-8' />
                ...
                <div className='h-80 lg:h-screen'></div>
                <div className='h-80 lg:h-96'></div>
              </div>

              {/* vertical border */}
              <div className='relative h-24 my-20 lg:my-64'>
                <div className='absolute left-1/2 v-border bg-gradient-to-b from-cyan-300 to-pink-300 text-center mx-auto' style={{ width: '1px', height: '0px', opacity: '0.5' }}></div>
              </div>
        ...
        <div className='pt-24 pl-7 bg-white z-0'>
        ...
        <div className='casestudy_ journal bg-stone-800 z-10'>
          ...
          <div className='grid grid-cols-4 space-x-2 ml-7'>
            <div className='relative'>
              <img className='garally object-cover h-72' src='grid1.jpg' width={640} height={853} />
              <div className='garally dark-filter'></div>
            ...
            <div className='relative'>
              <img className='garally object-cover h-72 ' src='grid2.jpg' width={640} height={853} />
              <div className='garally dark-filter'></div>
              <div className='mt-6 mb-4 h-0.5 w-full bg-gray-400'></div>
              <p className='text-gray-400 font-bold tracking-widest text-sm mb-4'>case study</p>
              <p className='text-gray-200 text-sm font-semibold tracking-widest leading-relaxed'>ブランドイメージ＆ムービー2021 / 中野製薬株式会社</p>
            ...
            <div className='relative'>
              <img className='garally object-cover h-72 ' src='grid3.jpg' width={640} height={853} />
              <div className='garally dark-filter'></div>
              <div className='mt-6 mb-4 h-0.5 w-full bg-gray-400'></div>
              <p className='text-gray-400 font-bold tracking-widest text-sm mb-4'>case study</p>
              <p className='text-gray-200 text-sm font-semibold tracking-widest leading-relaxed'>ブランドイメージ＆ムービー2021 / 中野製薬株式会社</p>
            ...
            <div className='relative'>
              <img className='garally object-cover h-72 ' src='grid4.jpg' width={640} height={853} />
              <div className='garally dark-filter'></div>
              <div className='mt-6 mb-4 h-0.5 w-full bg-gray-400'></div>
              <p className='text-gray-400 font-bold tracking-widest text-sm mb-4'>case study</p>
              <p className='text-gray-200 text-sm font-semibold tracking-widest leading-relaxed'>ブランドイメージ＆ムービー2021 / 中野製薬株式会社</p>
